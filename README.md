...
## 🚀 Features
- **Modern Chat UI:** Clean and responsive chat interface.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/Ziad-Gabriel/clone_WhatsApp.git](https://github.com/Ziad-Gabriel/clone_WhatsApp.git)
